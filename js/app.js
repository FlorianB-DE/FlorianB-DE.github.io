...
(function (ColorFunctions) {
    ...
    function randomColors(element) {
        ...
        var characters = element.innerText.split("");
        ...
        element.innerHTML = characters.reduce(function (a, ch, index) {
            ...
            return a + "<span style=\"color:".concat(colors[index - 1], "\">").concat(ch, "</span>");
        });
    }
    ...
    function getRandomRGBArray() {
        ...
        var generatedRGBArray = __spreadArray([], backgroundRGBArray, true);
    ...
    function hexToRGB(hexColor) {
        if (hexColor.replace("#", "").length == 3) {
            return hexToRGB(__spreadArray([], hexColor, true).reduce(function (accumulator, currentHex) { return accumulator + currentHex + currentHex; }).replace("#", ""));
        }
